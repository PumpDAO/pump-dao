...
#     token.transfer(accounts[1], amount, {'from': accounts[0]})
#
#     assert token.balanceOf(accounts[1]) == receiver_balance + (amount * 0.97)
#
#
...
#
#     assert token.balanceOf(accounts[0]) == sender_balance - (amount * 0.03)
#
#
...
#     token.transferFrom(accounts[0], accounts[2], amount, {'from': accounts[1]})
#
#     assert token.balanceOf(accounts[2]) == receiver_balance + (amount * 0.97)
#
#
