...
contract PumpTokenV2 is OwnableUpgradeable {
    ...
    function initialize_antibot(address _pinkAntiBot) public onlyOwner {
    ...
    function includeAddress(address _addrToInclude) public {
        require(
            msg.sender == owner() || msg.sender == electionManagerAddr,
            "Not approved to exclude"
        );
        _cannonTaxExcluded[_addrToInclude] = false;
    }
    ...
    function setEnableAntiBot(bool _enabled) external onlyOwner {
